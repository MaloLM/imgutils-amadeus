...
_PACKAGE_NAME = 'amadeus-imgutils'
...
setup(
    ...
    package_data={
        package_name: ['*.yaml', '*.yml', '*.json', '*.png', '*.onnx']
        for package_name in find_packages(include=('*'))
    },
    description='image utils lib based on the heavier lib https://github.com/deepghs/imgutils',
